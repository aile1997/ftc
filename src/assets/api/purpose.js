...
const Purpose = () => {
  ...
  loadingManager.onLoad = function () {
    ...
    new TWEEN.Tween(yPosition)
      ...
      .start()
      .onUpdate(function () {
        looadingCover.style.setProperty("opacity", yPosition.op);
  ...
  const fillLight2 = new PointLight(0x88b2d9, 2.7, 4, 3);
  ...
  document.getElementById("aglaea").addEventListener("click", () => {
    ...
    document.getElementById("content").innerHTML =
      "She was venerated as the goddess of beauty, splendor, glory, magnificence, and adornment. She is the youngest of the Charites according to Hesiod. Aglaea is one of three daughters of Zeus and either the Oceanid Eurynome, or of Eunomia, the goddess of good order and lawful conduct. we have a beautiful family.";
  ...
  document.getElementById("thalia").addEventListener("click", () => {
    ...
    document.getElementById("euphre").classList.remove("active");
    document.getElementById("content").innerHTML =
      "Thalia, in Greek religion, one of the nine Muses, patron of comedy; also, according to the Greek poet Hesiod, a Grace (one of a group of goddesses of fertility). She is the mother of the Corybantes, celebrants of the Great Mother of the Gods, Cybele, the father being Apollo, a god related to music and dance. In her hands she carried the comic mask and the shepherd’s staff. We need joy.";
